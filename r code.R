...
# log value
bird_div<-log10(bird_div)
fish_div<-log10(fish_div)
mammal_div<-log10(mammal_div)
primate_div<-log10(primate_div)
reptile_div<-log10(reptile_div)
rodent_div<-log10(rodent_div)
...
plot(fish_eye,fish_div,xlim=x,ylim=y,ylab="log10(eye axis / weight)",xlab="Eye axis",pch="🦐",cex=2,main="Eye axis vs. log10((eye axis) / (body weight))\n Fish",col="#FDE666",lwd=2)
abline(fish_line,lty=2,lwd=2,col="#8333a2")
legend('topright', legend =fish_rf , bty = 'n')

plot(mammal_eye,mammal_div,xlim=x,ylim=y,main="Mammal",ylab="log10(eye axis / weight)",xlab="Eye axis",pch="🕷",cex=2,col="#FFCB05")
abline(fish_line,lty=2,lwd=2,col="#8333a2")
legend('topright', legend =mammal_rf , bty = 'n')

plot(primate_eye,primate_div,xlim=x,ylim=y,main="Primate",ylab="log10(eye axis / weight)",xlab="Eye axis",pch = "🐍",cex=2,col="#DE656B")
abline(primate_line,lty=2,lwd=2,col="#8333a2")
legend('topright', legend =primate_rf , bty = 'n')

plot(reptile_eye,reptile_div,xlim=x,ylim=y,main="Reptile",ylab="log10(eye axis / weight)",xlab="Eye axis",pch="🦖",cex=2,col="#C83B55",lwd=2)
abline(reptile_line,lty=2,lwd=2,col="#8333a2")
legend('topright', legend =reptile_rf , bty = 'n')

plot(rodent_eye,rodent_div,xlim=x,ylim=y,main="Rodent",ylab="log10(eye axis / weight)",xlab="Eye axis",pch="🧍",cex=2,col="#171411")
